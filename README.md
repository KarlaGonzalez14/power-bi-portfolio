...
Este portafolio tiene como objetivo demostrar mis competencias como **Data Analyst / BI Analyst** en:
...
- Storytelling y comunicación de insights
...
|--------|------|-------------|
| 📦 Inventory Management Dashboard | Operaciones / Inventarios | Análisis dinámico del inventario por producto y subproducto, movimiento mensual, valorización a costo y precio de venta. |
